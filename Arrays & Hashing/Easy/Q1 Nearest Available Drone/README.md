...
| **Link** | [View Problem](https://leetcode.com/problems/nearest-available-drone/) |
| **Runtime** | 0 ms |
| **Memory** | 55.4 MB |

## Approach

compute dis and compare it with curr smallest dis. if it is <= range and smallest. its index is the currAns
