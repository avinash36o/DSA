...
| **Link** | [View Problem](https://leetcode.com/problems/minimize-the-maximum-waiting-time-at-synchronized-traffic-lights/) |
| **Runtime** | 6 ms |
| **Memory** | 178.8 MB |

## Approach

calculate the r. if r>highest element in light we will do ans=max(ans, period-r)
