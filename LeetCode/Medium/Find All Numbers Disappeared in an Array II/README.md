...
| **Link** | [View Problem](https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array-ii/) |
| **Runtime** | 94 ms |
| **Memory** | 242.1 MB |

## Approach

sort nums. if nums[i] out of boundary, continue. make interval and push it in ans;
